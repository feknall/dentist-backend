 ...
 */
package kavenegar.sdk;

import com.google.gson.*;
import kavenegar.sdk.enums.MessageType;
import kavenegar.sdk.excepctions.ApiException;
import kavenegar.sdk.excepctions.BaseException;
import kavenegar.sdk.excepctions.HttpException;
import kavenegar.sdk.models.*;
import kavenegar.sdk.utils.PairValue;
import kavenegar.sdk.utils.StringUtils;
    ...
    */
    ...
    public List<SendResult> sendArray(List<String> senders, List<String> receptors, List<String> messages, String localId) throws BaseException {
        ...
        for (int i = 0; i < receptors.size(); i++) {
            types.add(kavenegar.sdk.enums.MessageType.MobileMemory);
